...
```sh
$ sudo docker run -d --privileged --restart=unless-stopped --net=host -v /etc/kubernetes:/etc/kubernetes -v /var/run:/var/run rancher/rancher-agent:v2.4.3 --server https://18.231.185.239 --token 8d95qswq8hlss8p5f9b7gfxpnntk5xs7gw4w824rxvp7srg8rtjqtd --ca-checksum 5d022b8de4feb527c01d26cd4cc967912e9ffddc77f13641c4fa90fb96cfee4f --node-name k8s-1 --etcd --controlplane --worker
```
